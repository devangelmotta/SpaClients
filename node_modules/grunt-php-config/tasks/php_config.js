    ...
    grunt.registerMultiTask('php_config', 'Builds a PHP config and constants file', function() {
        ...
        if (!this.errorCount)
            this.files.forEach(function (f) {
                grunt.log.write(JSON.stringify(f));
                grunt.log.write(util.format('%s %s saved in %s file %s.', constants.length.toString().cyan, grunt.util.pluralize(constants.length, "constant/constants"), options.type, f.dest));
